...
import fallbackimageSRC from '@/public/images/3.jpeg';
    ...
    return (
        ...
        /> */}
                ...
                <div className='absolute top-2 left-2 z-20'>
                    <Badge variant='outline' className={`${CATEGORY_COLORS[product.categoria ?? 'Todos']} border-0`}>
                        {CATEGORY_NAMES[product.categoria ?? 'Todos']}
                    </Badge>
                </div>
            </div>
